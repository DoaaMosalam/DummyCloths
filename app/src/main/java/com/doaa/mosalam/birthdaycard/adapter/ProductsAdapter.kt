...
class ProductsAdapter(private val products : List<ProductsList>): RecyclerView.Adapter<ProductsAdapter.ProductsViewHolder>() {
    ...
    inner class ProductsViewHolder(val product : ProductsItemBinding): RecyclerView.ViewHolder(product.root)
}